...
class Environment {
 public:
  static bool ConvertEquirectangular(const std::shared_ptr<Texture2D> &tex_in,
                                     std::shared_ptr<TextureCube> &tex_out);

  static bool GenerateIrradianceMap(const std::shared_ptr<TextureCube> &tex_in,
                                    std::shared_ptr<TextureCube> &tex_out);

  static bool GeneratePrefilterMap(const std::shared_ptr<TextureCube> &tex_in,
                                   std::shared_ptr<TextureCube> &tex_out);
